...
t2w () {
    ...
    -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel  --PO 'map=.*/ttt.*:r_TTTT[1,-5,5]' --PO 'map=.*/ttW:r_TTW[1,-5,5]' --PO 'map=.*/ttZ:r_TTZ[1,-5,5]' --channel-masks
}
...
significance () {
    ...
    -n .ObsSign --job-mode condor --task-name significance_obs
    ...
    -n .AsiSign --job-mode condor --task-name significance_asi
}
...
collect_gof () {
    for i in */; do
        ...
        # cd cr_only_true
        # combineTool.py -M CollectGoodnessOfFit --input higgsCombine.Test.GoodnessOfFit.mH125.root higgsCombine.Test.GoodnessOfFit.mH125.12345.root -m 125 -o gof.json
        # plotGof.py gof.json --statistic saturated --mass 125.0 -o aaaaa_gof_plot
        # cd ..
        # cd gof_cr_2l_only
        # combineTool.py -M CollectGoodnessOfFit --input higgsCombine.Test.GoodnessOfFit.mH125.root higgsCombine.Test.GoodnessOfFit.mH125.12345.root -m 125 -o gof.json
        # plotGof.py gof.json --statistic saturated --mass 125.0 -o aaaaa_gof_plot
